    ...
    <div class="py-8">
        <div class="container">
            <div class="card p-6 sm:p-8 max-w-3xl mx-auto"
                x-data="calendarWizard({ submitUrl: @js(route('calendars.wizard.store')) })">
                            ...
                            <div class="max-w-md mx-auto space-y-5">
                                ...
                                <div class="flex items-center gap-3 pt-2">
                                    <button type="button" @click="saveMemberAndContinue()" :disabled="!memberFormValid"
                                        class="btn btn-outline flex-1">שמירה והוספה של עוד</button>
                                    <button type="button" @click="saveMember()" :disabled="!memberFormValid"
                                        class="btn btn-primary flex-1">שמירת הפרטים</button>
                                </div>
                            </div>
                        </div>
                    </template>
                ...
                {{-- Footer navigation --}}
                <div class="mt-8 pt-6 border-t border-ink-200 flex items-center justify-between gap-3">
                    ...
                    <button type="button"
                        ...
                        x-cloak @click="next()" :disabled="!canProceed" class="btn btn-primary">
                        המשך ←
                    </button>

                    <button type="button"
                        x-show="currentStep === 'members' && !memberPanelOpen"
                        x-cloak @click="goToStep(3)" class="btn btn-primary">
                        דילוג לסיכום ←
                    </button>
