<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h1 class="text-2xl font-semibold text-[#1A1A1E]">הוסף חבר משפחה חדש</h1>
    ...
    <div class="py-8">
        <div class="container">
            <div class="card p-6 max-w-xl mx-auto">
                <form action="{{ route('family-members.store') }}" method="POST" class="space-y-4">
                    @csrf
                    ...
                    <div>
                        ...
                        <textarea name="notes" id="notes" rows="3"
                            class="input"
                            placeholder="הערות נוספות על חבר המשפחה">{{ old('notes') }}</textarea>
                    </div>
